      ...
      <section className="pt-28 md:pt-36 pb-0 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            style={{ fontFamily: "Poppins, sans-serif" }}
          >
            One of several MapleCode projects — I designed and shipped 101 Healthcare's first website, then iterated post-launch until the numbers moved.
          </motion.p>
          ...
          >
            ...
            MapleCode is covered by NDA; this project is one I've been cleared to share in full.
          </motion.p>
