...
export function Process({ isDark }: ProcessProps) {
  ...
  return (
    <section
      id="process"
      className={`py-24 md:py-32 px-6 ${isDark ? "bg-[#0d0d13]" : "bg-gray-50/50"}`}
    >
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-6 lg:gap-24">
            ...
            <div className="lg:max-w-sm pb-1">
              <p
                ...
                style={{ fontFamily: "Poppins, sans-serif" }}
              >
                A patented UX methodology by iMaginXP — applied fully on complex
                projects, adapted with agility for fast-moving ones.
              </p>
            </div>
          </div>
        </motion.div>
